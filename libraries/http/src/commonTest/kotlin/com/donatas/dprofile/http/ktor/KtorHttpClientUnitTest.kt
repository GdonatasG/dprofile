...
class KtorHttpClientUnitTest {
    ...
    private fun makeSUT(mockEngine: MockEngine, baseUrl: String): com.donatas.dprofile.http.HttpClient {
        return KtorHttpClient(HttpClient(mockEngine), baseUrl)
    }
    ...
    private suspend fun expectCoroutinesCancellationException(
        request: suspend (com.donatas.dprofile.http.HttpClient) -> Any,
